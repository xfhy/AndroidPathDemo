...
object InjectorUtil {
    ...
    private fun getPlaceRepository() = PlaceRepository.getInstance(CoolWeatherDatabase.placeDao, CoolWeatherNetwork.getInstance())

    private fun getWeatherRepository() = WeatherRepository.getInstance(CoolWeatherDatabase.weatherDao, CoolWeatherNetwork.getInstance())
